...
class TalhaoFormState extends State {
      ...
      return Scaffold(
          appBar: AppBar(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (BuildContext context) => TalhaoPage(this.fazenda)),
              );
            },
          ),
          ),
                ...
                Column(
                  children: <Widget>[
                    ...
                    TextField(
                      ...
                      onChanged: (value) => this.updateIdentificadorDoTalhao(),
  ...
  void updateFazendaId() {
    talhao.fazendaId = int.parse(fazendaIdController.text);
  }
}