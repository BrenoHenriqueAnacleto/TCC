...
import 'package:agroquality/tableModels/usuarioTableModel.dart';

UsuarioTableModel helper = UsuarioTableModel();
...
class UsuarioFormState extends State {
  ...
  void save() {
    ...
    if (usuario.id != null) {
      helper.updateUsuario(usuario);
    } else {
      helper.insertUsuario(usuario);
    }
